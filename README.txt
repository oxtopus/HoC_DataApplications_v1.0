...
======================================
  ...
  They require the Processing programming environment to be run and raw point cloud data (downloaded separately).
...
--------------------------
  ...
  This version has been adapted from the original to work with recent (as of May 2015) version of Processing 2.0.
  Make sure the data files are directly within your sketch's "data" directory, and are extracted from any zip files.
  You can get the original source code, with raw data from https://github.com/dataarts/radiohead
